...
<div id="page-wrapper"><div id="page">
  ...
  <div id="header"><div class="section">
			<div id="logo">
			      <a href="<?php print $front_page; ?>" title="<?php print $site_name; ?>" rel="home"><img src="<?php print $base_path . $directory; ?>/images/logo.png" alt="<?php print $site_name; ?>"/></a>
			</div>
			<div id="more-info">
				<img id="phone" src="<?php print $base_path . $directory; ?>/images/phone-number.png" />
				<span>Special Financing Available. <a href="<?php print $base_path?>contact">Learn More.</a>
			</div>
		</div><!-- /section -->
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" class="clearfix">
	...
	<div id="footer-wrapper"><div class="section">
	    ...
	    <span id="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?> <?php print $site_name; ?></span>
